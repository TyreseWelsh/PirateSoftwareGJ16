...
public class ShootComponent : MonoBehaviour
{
    ...
    public void AddGun(GunScriptableObject newGunData)
    {
        ...
        if(newGun)
        {
            ...
            newGun.transform.localPosition = new Vector3(newGun.transform.localPosition.x + Random.Range(1.5f, 2f), newGun.transform.localPosition.y + Random.Range(-0.75f, 0.75f), newGun.transform.localPosition.z + Random.Range(-1f, 1f));
        }
